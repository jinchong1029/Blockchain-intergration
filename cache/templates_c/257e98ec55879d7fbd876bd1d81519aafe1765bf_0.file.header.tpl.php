...
/* Smarty version 3.1.30, created on 2020-05-29 15:37:02
  from "/home/bligeoyh/public_html/template/header.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ed1645ed40152_61925029',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '257e98ec55879d7fbd876bd1d81519aafe1765bf' => 
    array (
      0 => '/home/bligeoyh/public_html/template/header.tpl',
      1 => 1590736689,
      2 => 'file',
    ),
  ),
...
function content_5ed1645ed40152_61925029 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html lang="en" class="wf-poppins-n3-active wf-poppins-n4-active wf-poppins-n5-active wf-poppins-n6-active wf-poppins-n7-active wf-roboto-n3-active wf-roboto-n4-active wf-roboto-n5-active wf-roboto-n6-active wf-roboto-n7-active wf-active">
   <head>
      ...
      <?php } elseif ($_smarty_tpl->tpl_vars['page']->value == 'faqs') {?>
...
>
      ...
      <?php echo '<script'; ?>
 src="../assets/js/head.js" charset="utf-8"><?php echo '</script'; ?>
>
      ...
      <div class="kt-grid kt-grid--hor kt-grid--root">
         <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
            ...
            <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
               ...
               <?php if ($_smarty_tpl->tpl_vars['userDetails']->value['accountType'] == 'Member') {?>
               <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                  <div id="kt_aside_menu" class="kt-aside-menu kt-scroll" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" style="height: 909px; overflow: auto;">
                     <ul class="kt-menu__nav ">
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'home') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'fullz') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'banks') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'accounts') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'tools') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'tutorials') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'addfunds') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'tickets') {?> kt-menu__item--active <?php } elseif ($_smarty_tpl->tpl_vars['page']->value == 'showticket') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'tos') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
               ...
               <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                  <div id="kt_aside_menu" class="kt-aside-menu kt-scroll" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" style="height: 909px; overflow: auto;">
                     <ul class="kt-menu__nav ">
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_dashboard') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_users') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_fullz') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_banks') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_accounts') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_tools') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_tutorials') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_payments') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_news') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_tickets') {?> kt-menu__item--active <?php } elseif ($_smarty_tpl->tpl_vars['page']->value == 'cp_replyticket') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item  <?php if ($_smarty_tpl->tpl_vars['page']->value == 'cp_tos') {?> kt-menu__item--active <?php }?>" aria-haspopup="true">
                     ...
                     <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                           <div class="kt-header__topbar-user">
                                  ...
                                  <span class="kt-header__topbar-username"><?php echo $_smarty_tpl->tpl_vars['userDetails']->value['username'];?>
</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                           <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(../assets/images/bg-1.jpg)">
                              ...
                              <div class="kt-user-card__details">
                                  <div class="kt-user-card__name"><?php echo $_smarty_tpl->tpl_vars['userDetails']->value['username'];?>
</div>
                                  <div class="kt-user-card__position" style="color:#fff">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['userDetails']->value['balance'];?>
¢ available</div>
                              </div>
                           </div>
                     ...
                     <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                          ...
                          <?php }?>
                           ...
                           <span class="kt-subheader__desc"><?php echo $_smarty_tpl->tpl_vars['userDetails']->value['pfmId'];?>
</span>
                        </div>
